 ...
 * @param {Object} An axios request object, with any available headers set
 */
...
/**
 * Submit the provided axios request object, invoke a callback (if it was
 ...
 * @returns {Promise} A promise to the axios request
 */
function invokeAndPromisify( request, callback, transform ) {
	return new Promise( ( resolve, reject ) => {
		...
		// axios response object as response.body (containing the response
...
/**
 * Extract and return the headers property from an axios response object
 *
 * @private
 * @param {Object} result The results from the HTTP request
